...
class ShortyGroup extends Character {
    ...
    public String pullRope(Znayka znayka, Rope rope) {
        ...
        if(znayka.getWeight() < 90){
            ...
            return (getName() + " принялись тянуть веревку, но не смогли притянуть " + znayka.getName() +  " обратно к дому с первого раза из-за " + znayka.getActionGenderText(Action.PRONOUNS_HIS) + " большого веса.\n");
        }
    }
