...
rollup index_base.js --format iife --name "myBundle" --file bundle.js
```
...
rollup index_base.js --format cjs --file bundle.js
```
...
rollup index_base.js --format umd --name "myBundle" --file bundle.js
```
